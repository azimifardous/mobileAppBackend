...
namespace HrAppApi.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HrRequest>().HasData(
                new HrRequest { Id = 1, Type = "Leave", Title = "Vacation", Date = new DateTime(2025, 3, 20), Status = "Approved" },
                new HrRequest { Id = 2, Type = "Leave", Title = "Sick Leave", Date = new DateTime(2025, 1, 7), Status = "Pending" },
                new HrRequest { Id = 3, Type = "Leave", Title = "Vacation", Date = new DateTime(2025, 2, 22), Status = "Rejected" }
            );
        }
    }
}
